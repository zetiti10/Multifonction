...
public class MyPos implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		if (sender instanceof Player) {
			...
			Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "minecraft:tellraw " + player.getName() + " [\"\",{\"text\":\"Simplebot\",\"color\":\"yellow\"},{\"text\":\" » \",\"color\":\"dark_gray\"},{\"text\":\"Vous êtes en \",\"color\":\"blue\"},{\"text\":\"" + loc + "\",\"color\":\"aqua\",\"clickEvent\":{\"action\":\"copy_to_clipboard\",\"value\":\"" + loc + "\"}}]");
		} else {
